...
public enum ErrorCode {
    ...
    EMPLOYEE_AUTH_ERROR("EA001","존재하지 않는 사번이거나 가입 완료된 사번입니다.",HttpStatus.BAD_REQUEST),
    EMPLOYEE_AUTH_NOT_EQUAL_USERNAME_EMPLOYEE_NUM("EA002","사용자 이름과 일치하지 않는 사번입니다.",HttpStatus.BAD_REQUEST),
//    AUTH 관련 에러입니다.
